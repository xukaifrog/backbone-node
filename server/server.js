...
var createUser = function(req, res){
    var sql = 'insert into  user (firstname, lastname, age) values(?,?,?)';
    var body = req.body;
    var create = [body.firstname, body.lastname, body.age];
    sql = mysql.format(sql, create);
...
var deleteUser = function(req, res){
    var sql = 'delete from user where id=' + mysql.escape(req.params.id);
    pool.query(sql);
    res.send(true);
